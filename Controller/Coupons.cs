...
namespace ReferAll
{
    public class Coupons
    {
        #region Fields
        /// <summary>
        /// Instance of Coupons Class with create, validate, delete, update, list and consume method.
        /// </summary>
        ...
        public async void Create(string wp_id, string session_key, string title, string info, string value, string type, string limit, string exp, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(RAHost.Instance.BaseDomain + "/referall/v1/coupons/create", content);
        ...
        public async void Validate(string wp_id, string session_key, string copid, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(RAHost.Instance.BaseDomain + "/referall/v1/coupons/validate", content);
            response.EnsureSuccessStatusCode();
        ...
        public async void Delete(string wp_id, string session_key, string copid, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(RAHost.Instance.BaseDomain + "/referall/v1/coupons/delete", content);
            response.EnsureSuccessStatusCode();
        ...
        public async void Update(string wp_id, string session_key, string copid, string title, string info, string value, string type, string limit, string exp, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(RAHost.Instance.BaseDomain + "/referall/v1/coupons/update", content);
            response.EnsureSuccessStatusCode();
        ...
        #region List Method
        public async void List(string wp_id, string session_key, string copid, string status, string type, Action<bool, string> callback)
        {
            var dict = new Dictionary<string, string>();
                dict.Add("wpid", wp_id);
                dict.Add("snky", session_key);
            ...
            var response = await client.PostAsync(RAHost.Instance.BaseDomain + "/referall/v1/coupons/list", content);
            response.EnsureSuccessStatusCode();
        ...
        public async void Consume(string wp_id, string session_key, string copid, string odid, string type, Action<bool, string> callback)
        {
            ...
            var response = await client.PostAsync(RAHost.Instance.BaseDomain + "/referall/v1/coupons/consume", content);
            response.EnsureSuccessStatusCode();
